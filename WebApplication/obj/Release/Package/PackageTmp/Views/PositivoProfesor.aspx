<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Page.Master" AutoEventWireup="true" CodeBehind="PositivoProfesor.aspx.cs" Inherits="WebApplication.Views.PositivoProfesor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Portal de Profesor Positivo</p>
    ...
    <div class="mb-4 border-b border-gray-300 ">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 border-blue-600" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">Profesor Positivo</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 text-gray-500 border-gray-100 " id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Nuevo Profesor Positivo</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 text-gray-500  border-gray-100 " id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Buscar Profesor Positivo</button>
            </li>
    ...
    <div id="myTabContent" class="pb-12 ">
        ...
        <div class="hidden p-4 bg-gray-50 rounded-lg " id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
            <h5 class="text-xl font-medium text-gray-900 dark:text-white mb-4">Registra un Positivo Profesor</h5>
            <div class="grid md:grid-cols-2 md:gap-6 mb-4">
                <div class="relative z-0 mb-6 w-full group">
                    <label for="ContentPlaceHolder1_DropDownListProfesor" class="block mb-2 text-sm font-medium text-gray-400 ">Seleccione una opción</label>
                    <asp:DropDownList ID="DropDownListProfesor" CssClass="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" runat="server"></asp:DropDownList>
                </div>
                <div class="relative z-0 mb-6 w-full group">
        ...
        <div class="hidden p-10 bg-gray-50 rounded-lg  " id="settings" role="tabpanel" aria-labelledby="settings-tab">
            ...
            <div runat="server" id="Datos" class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <asp:Image ID="Image1" CssClass="rounded-t-lg" runat="server" />
                </a>
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Profesor positivo</h5>
                </a>
                ...
                <asp:Button ID="Button4" runat="server" CssClass="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" Text="Eliminar Profesor Positivo" OnClick="Button4_Click" />
            </div>
        </div>
    </div>
</asp:Content>
