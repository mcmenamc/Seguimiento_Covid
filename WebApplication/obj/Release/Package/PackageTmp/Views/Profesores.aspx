<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Page.Master" AutoEventWireup="true" CodeBehind="Profesores.aspx.cs" Inherits="WebApplication.Views.WebForm1" %>
    ...
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Portal de Gestión Profesores</p>
    ...
    <div class="mb-4 border-b border-gray-300 ">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            ...
            <li role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300  text-gray-500 border-gray-100 " id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Buscar Profesor</button>
            </li>
            <li role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300  text-gray-500 border-gray-100 " id="profe-tab" data-tabs-target="#profe" type="button" role="tab" aria-controls="profe" aria-selected="false">Seguimiento Profesor</button>
            </li>
        </ul>
    </div>
    <div id="myTabContent" class="pb-12 ">
        <div class=" " id="profile" role="tabpanel" aria-labelledby="profile-tab">
            ...
            <div class="overflow-x-auto relative pb-5">
                <asp:GridView ID="GridView2" runat="server" CssClass="w-full text-sm text-left text-gray-500 dark:text-gray-400" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
        ...
        <div class="hidden p-4 bg-gray-50 rounded-lg " id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
            <div class="overflow-x-auto relative">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="w-full text-sm text-left text-gray-500 " OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="25">
                    <PagerStyle ForeColor="DarkSlateBlue" HorizontalAlign="Center" Font-Bold="True" />
        ...
        <div class="hidden p-10 bg-gray-50 rounded-lg  " id="settings" role="tabpanel" aria-labelledby="settings-tab">
            ...
            <div class="grid md:grid-cols-3 md:gap-6 mb-4">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    <label for="ContentPlaceHolder1_DropDownListCategoria" class="block mb-2 text-sm font-medium text-gray-400">Seleccione una opción</label>
        ...
        <div class="hidden p-4 bg-gray-50 rounded-lg" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
            <div class="grid md:grid-cols-3 md:gap-6 mb-4">
                <div class="relative z-0 mb-6 w-full group">
                    <asp:TextBox ID="buscaid" runat="server" type="number" CssClass="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "></asp:TextBox>
                    <label for="ContentPlaceHolder1_TextBoxRegistro" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Registro Empleado</label>
                </div>
                <div>
            ...
            <div runat="server" id="Datos" class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Categoría:
                    <asp:Label ID="Categoria" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Correo:
        ...
        <div class="hidden p-4 bg-gray-50 rounded-lg" id="profe" role="tabpanel" aria-labelledby="profe-tab">
            <div class="grid md:grid-cols-3 md:gap-6 mb-4">
                <div class="relative z-0 mb-6 w-full group">
                    <asp:TextBox ID="TextBox1" runat="server" type="number" CssClass="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " ></asp:TextBox>
                    <label for="ContentPlaceHolder1_TextBoxRegistro" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Registro Empleado</label>
                </div>
                <div>
                    <asp:Button ID="Button5" CssClass="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" runat="server" Text="Buscar Profesor" OnClick="Button5_Click" />
                </div>
            </div>
            <div runat="server" id="seguimieto" class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Profesor</h5>
                </a>
                <a href="#">
                    <asp:Image class="rounded-t-lg" ID="Image1" runat="server" />
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Nombre Completo:
                    <asp:Label ID="SCompledo" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Veces Contagiadas:
                    <asp:Label ID="Veces_Contagiadas" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Correo:
                    <asp:Label ID="scorreo" runat="server" Text="" CssClass="font-ligh"></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Teléfono:
                    <asp:Label ID="sCelular" runat="server" Text="" CssClass="font-ligh"></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Genero:
                    <asp:Label ID="sGenero" runat="server" Text="" CssClass="font-ligh"></asp:Label>
                </p>
            </div>
        </div>
    </div>
