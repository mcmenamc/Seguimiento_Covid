<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Page.Master" AutoEventWireup="true" CodeBehind="SeguimientoAlumno.aspx.cs" Inherits="WebApplication.Views.SeguimientoAlumno" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
                ...
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Portal de Gestión de  Seguimiento Alumno</p>
    ...
    <div class="mb-4 border-b border-gray-300 ">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 text-blue-600 hover:text-blue-600 border-blue-600" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">Seguimiento Alumno</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 text-gray-500 border-gray-100 " id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Nuevo Seguimiento Alumno</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 text-gray-500  border-gray-100 " id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Buscar Seguimiento Alumno</button>
            </li>
    ...
    <div id="myTabContent" class="pb-12 ">
        ...
        <div class="hidden p-4 bg-gray-50 rounded-lg " id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
            <h5 class="text-xl font-medium text-gray-900 dark:text-white mb-4">Registra un nuevo Seguimiento Alumno</h5>
            <div class="grid md:grid-cols-2 md:gap-6 mb-4">
                <div class="relative z-0 mb-6 w-full group">
                    <label for="ContentPlaceHolder1_DropDownListMedico" class="block mb-2 text-sm font-medium text-gray-400 ">Seleccione una opción</label>
                    <asp:DropDownList ID="DropDownListMedico" CssClass="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" runat="server"></asp:DropDownList>
                </div>
                <div class="relative z-0 mb-6 w-full group">
                    <label for="ContentPlaceHolder1_DropDownListPositivoAlumno" class="block mb-2 text-sm font-medium text-gray-400 ">Seleccione una opción</label>
                    <asp:DropDownList ID="DropDownListPositivoAlumno" CssClass="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6 mb-4">
                <div class="relative z-0 mb-6 w-full group">
                    <asp:TextBox ID="TextBoxEntrevista" runat="server" CssClass="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "></asp:TextBox>
                    <label for="TextBoxEntrevista" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Matricula</label>
                </div>
                <div class="relative z-0 mb-6 w-full group">
                    <asp:TextBox ID="TextBoxReporte" runat="server" CssClass="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "></asp:TextBox>
                    <label for="TextBoxReporte" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nombre</label>
                </div>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6 mb-4">
                <div class="relative z-0 mb-6 w-full group">
                    <asp:TextBox ID="TextBoxComunicacion" runat="server" CssClass="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "></asp:TextBox>
                    <label for="TextBoxEntrevista" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Matricula</label>
                </div>
                <div class="relative  z-0 mb-6 w-full group">
                    ...
                    <asp:TextBox ID="FechaSeguimiento" runat="server" datepicker type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg   block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="Inicio del Cuatrimestre"></asp:TextBox>
                </div>
            </div>
        ...
        <div class="hidden p-10 bg-gray-50 rounded-lg  " id="settings" role="tabpanel" aria-labelledby="settings-tab">
            ...
            <div runat="server" id="Datos" class="p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Seguimiento Alumno</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Nombre del Médico:
                    <asp:Label ID="Medico" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Nombre del paciente:
                    <asp:Label ID="pacieente" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Entrevista:
                    <asp:Label ID="entrevista" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Reporte:
                    <asp:Label ID="reporte" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 ">
                    Fecha Seguimiento:
                    <asp:Label ID="fecha" CssClass="font-ligh" runat="server" Text=""></asp:Label>
                </p>
